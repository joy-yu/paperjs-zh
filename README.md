...
* 可以检查并控制任何项目的精确边界框，支持具有不同行程末端和斜接限制的复杂笔划样式。Inspect and manipulate the precise bounding box of any item, supporting complicated stroke styles with different stroke ends and miter limits.
